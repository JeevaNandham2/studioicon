    ...
    <div className="min-h-screen bg-background relative overflow-hidden">
          ...
          <div className="space-y-8 lg:pr-8 z-10 relative">
            <div className="space-y-6">
              <h1 className="text-5xl lg:text-6xl xl:text-7xl font-serif text-foreground leading-tight">
                ...
                <br />
                <span className="font-accent text-purple-400">Moments</span>
              </h1>
        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-5xl font-serif text-foreground mb-4">
              <span className="font-script text-orange-500">What We</span> Do
            </h2>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="space-y-6">
              <h2 className="text-5xl font-serif text-foreground">
                <span className="font-script text-orange-500">About</span> Studio Icon
              </h2>
      ...
      <section className="py-20 bg-white overflow-hidden relative">
        ...
        <div className="text-center mb-16 px-6">
          <h2 className="text-5xl font-serif text-foreground mb-4">
            <span className="font-script text-orange-500">Our</span> Portfolio
          </h2>
